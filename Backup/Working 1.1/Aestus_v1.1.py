...
import speech_recognition as sr  # POTRZEBUJE DOSTĘPU DO INTERNETU
...
# TODO ZROBIĆ BACKUP ! BAKUP


# TODO Przygotować ankietę!


# DONE posprawdzać pisownie printów i mow'ów
# DONE dodać instrukcje

# JUZ NIE TRZEBA  B-)  dodać informacje o nie używaniu polskich znaków
# DONE dodać czyszczenie poszczególnych dni


# DONE dokonczyć panel administratora
# DONE dodać przełącznik mowy w panelu admina
# DONE SPRAWDZIC CZY DZIALA - DZIALA
# DONE przenieść usuwanie terminów pracy do admina
...
def wybor3():
    ...
    imie = ''
    nazwisko = ''
    print('Aby rozpocząć rezerwację, wpisz najpierw swoje imię i wciśnij enter:' + '\n')
    mow('Aby rozpocząć rezerwację, wpisz najpierw swoie imię i wciśnij enter.')
    imie = input('Imię: ')
    print('Teraz wpisz swoje nazwisko i wciśnij enter:' + '\n')
    print('Nazwisko: ', end=' ')
