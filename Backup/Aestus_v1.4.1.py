    ...
    def wybor_awaryjny():
        ...
        if wybor_awaryjny_input == str('1'):
            ...
            if wybor_audio_a == 'jeden':
                ...
                wybor_a = str(5)
            elif wybor_audio_a == 'piec':
                wybor_a = str(5)
            elif wybor_audio_a == '5':
                wybor_a = str(5)
            elif wybor_audio_a == 'cześć':
                wybor_a = str(6)
            elif wybor_audio_a == 'czesc':
                wybor_a = str(6)
    ...
    def wybor_awaryjny():
        ...
        if wybor_awaryjny_input == str('1'):
            ...
            if wybor_audio == 'jeden':
                ...
                dzien = str(5)
            elif wybor_audio == 'piaty':
                dzien = str(5)
            elif wybor_audio == 'szósty':
                dzien = str(6)
            elif wybor_audio == 'szosty':
                dzien = str(6)
            elif wybor_audio == 'siódmy':
                dzien = str(7)
            elif wybor_audio == 'siodmy':
                dzien = str(7)
            elif wybor_audio == 'poniedziałek':
                dzien = str(1)
            elif wybor_audio == 'poniedzialek':
                dzien = str(1)
            elif wybor_audio == 'wtorek':
                dzien = str(2)
            elif wybor_audio == 'środa':
                dzien = str(3)
            elif wybor_audio == 'sroda':
                dzien = str(3)
            elif wybor_audio == 'czwartek':
                dzien = str(4)
            elif wybor_audio == 'piątek':
                dzien = str(5)
            elif wybor_audio == 'piatek':
                dzien = str(5)
            elif wybor_audio == 'sobota':
                dzien = str(6)
            elif wybor_audio == 'niedziela':
...
def wybor1Godzina():
    ...
    def wybor_awaryjny():
        ...
        if wybor_awaryjny_input == str('1'):
            ...
            if wybor_audio == 'szósta':
                godzina = str(6)
            elif wybor_audio == 'szosta':
                godzina = str(6)
            elif wybor_audio == 'siódma':
                godzina = str(7)
            elif wybor_audio == 'siodma':
                godzina = str(7)
            elif wybor_audio == 'ósma':
                godzina = str(8)
            elif wybor_audio == 'osma':
                godzina = str(8)
            elif wybor_audio == 'dziewiąta':
                godzina = str(9)
            elif wybor_audio == 'dziewiata':
                godzina = str(9)
            elif wybor_audio == 'dziesiąta':
                godzina = str(10)
            elif wybor_audio == 'dziesiata':
                godzina = str(10)
            elif wybor_audio == 'jedenasta':
                godzina = str(11)
            elif wybor_audio == 'dwunasta':
                ...
                godzina = str(19)
            elif wybor_audio == 'dziewietnasta':
                godzina = str(19)
            elif wybor_audio == 'dwudziesta':
                godzina = str(20)
            if wybor_audio == '6:00':
                ...
                godzina = str(9)
            elif wybor_audio == 'dziewiec':
                godzina = str(9)
            elif wybor_audio == 'dziesięć':
                godzina = str(10)
            elif wybor_audio == 'dziesiec':
                godzina = str(10)
            elif wybor_audio == 'jedenaście':
                godzina = str(11)
            elif wybor_audio == 'jedenascie':
                godzina = str(11)
            elif wybor_audio == 'dwanaście':
                godzina = str(12)
            elif wybor_audio == 'dwanascie':
                godzina = str(12)
            elif wybor_audio == 'trzynaście':
                godzina = str(13)
            elif wybor_audio == 'trzynascie':
                godzina = str(13)
            elif wybor_audio == 'czternaście':
                godzina = str(14)
            elif wybor_audio == 'czternascie':
                godzina = str(14)
            elif wybor_audio == 'piętnaście':
                godzina = str(15)
            elif wybor_audio == 'pietnascie':
                godzina = str(15)
            elif wybor_audio == 'szesnaście':
                godzina = str(16)
            elif wybor_audio == 'szesnascie':
                godzina = str(16)
            elif wybor_audio == 'siedemnaście':
                godzina = str(17)
            elif wybor_audio == 'siedemnascie':
                godzina = str(17)
            elif wybor_audio == 'osiemnaście':
                godzina = str(18)
            elif wybor_audio == 'osiemnascie':
                godzina = str(18)
            elif wybor_audio == 'dziewiętnaście':
                godzina = str(19)
            elif wybor_audio == 'dziewietnascie':
                godzina = str(19)
            elif wybor_audio == 'dwadzieścia':
                godzina = str(20)
            elif wybor_audio == 'dwadziescia':
                godzina = str(20)
            else:
                print('\n' + 'Proszę wybrać odpowiednią liczbę!' + '\n' + '\n')
                mow('Proszę wybrać odpowiednią liczbę.')
