import os, sys, winsound, PIL.Image, random, webbrowser, time
...
#todo instrukcja
def instrukcja():
    print('Oto krótka instrukcja, uzywaj głosowych zwrotów takich jak, jeden, dwa, trzy, aby wybierać poszczególne opcje z menu.')
    mow('Oto krótka instrukcja, uzywaj głosowych zwrotów takich jak, jeden, dwa, trzy, aby wybierać poszczególne opcje z menu.')
...
def intro():
    print('\n' + 'Aby sprawdzić dostępność torów powiedz 1.'
                 ...
                 '\nAby otworzyć panel pracownika powiedz 6.' + '\n')
...
def intro_1():
    ...
    with sr.Microphone() as source:
        ...
        if wybor == str(5):
            ...
            stronainternetowa()
        if wybor == str(6):
            print('\n' + 'Otwieranie panelu pracownika.')
            mow('Otwieranie panelu pracownika.')
            haslo()
        else:
    ...
    if dzien.isdigit():
        if godzina.isdigit():
            if int(godzina) < 21 and int(godzina) > 5 and int(dzien) > 0 and int(dzien) < 8:
                ...
                print('\n' + 'Termin niedostepny. Aby wybrac inny termin powiedz 1, aby wrocic do menu glownego powiedz 2.' + '\n')
...
def wybor2Printy():
    ...
    mow('Wybierz poziom zaawansowania, aby wybrać poziom początkujący powiedz jeden, aby wybrać poziom średniozaawansowany powiedz dwa, aby wybrać poziom zaawansowany powiedz trzy,')
    print('Słucham...')
    mow('Słucham')
    wybor2()
    ...
    if dzien.isdigit():
        if godzina.isdigit():
            if int(godzina) < 21 and int(godzina) > 5 and int(dzien) > 0 and int(dzien) < 8:
                for element in termin:
                    if element[0] == str(dzien):
                        if element[1] == str(godzina):
                            zajety = 1
                            print('\n' + 'Termin niedostępny. Aby wybrać inny termin powiedz jeden, aby wrocic do menu głównego powiedz dwa.' + '\n')
                            mow('')
                            wybor3_1()
                if zajety == 0:
                    ...
                    outfile.write(dzien + '\t' + godzina + '\t' + imie + '\t' + nazwisko + '\t' + str(poziom_zaaw) + '\n')
                    outfile.close()
                ...
                print('\n' + 'Termin niedostępny. Aby wybrać inny termin powiedz jeden, aby wrócić do menu głównego powiedz dwa.' + '\n')
                mow('Termin niedostępny. Aby wybrać inny termin powiedz jeden, aby wrócić do menu głównego powiedz dwa.')
                wybor3_2()
    else:
        print('Potrzebna liczba!' + '\n')
        mow('Potrzebna liczba!')
