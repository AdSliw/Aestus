...
outfile1.write('\n' + 'Nowa instancja programu. Sygnatura instancji: ' + str(teraz) + '\n' +
               '- - - - - - - - - - - - - - - - - - - - - - - - - -' + '\n')
outfile1.write('Czas wykonania operacji:' + '\t' + 'ID' + ':'
               + '\t' + '[D: , G: ]' + '\t' + '\n')
outfile1.close()
...
outfile2.write('\n' + 'Nowa instancja programu. Sygnatura instancji: ' + str(teraz) + '\n' +
               '- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -' + '\n')
outfile2.write('Czas wykonania operacji:' + '\t' + 'ID' + ':' + '\t' +
               '[[Nr: ], [M: , D: ], [S: , K: ]]' + '\t' + '\n')
outfile2.close()
...
def start():
    ...
    print('Witaj w programie Aestus.' + '\n'
          ...
          '   / /\ \ / _ \/ __| __| | | / __|' + '\n'
          '  / ____ \  __/\__ \ |_| |_| \__ \ ' + '\n'
          ' /_/    \_\___||___/\__|\__,_|___/ v1.4.3' + '\n')
    print('Ładowanie...')
    time.sleep(3)
            ...
            if int(godzina) < 21 and int(godzina) > 5 and int(dzien) > 0 and int(dzien) < 8:
                ...
                if zajety == 0:
                    ...
                    if godzina == '6':
                        ...
                        godzina_print = str('Od 9:00 do 10:00')
                    elif godzina == '10':
...
def stronainternetowa():
    webbrowser.open('https://posir.poznan.pl/obiekty/winogrady/plywalnia-kryta',
...
def dzieki():
    ...
    def wybor_awaryjny():
        ...
        if wybor_awaryjny_input == str('1'):
            ...
            wybor_audio = input('Którą opcję wybierasz?\n')
            if wybor_audio == 'jeden':
                wybor_inna_opcja_5_a = str(1)
            elif wybor_audio == '1':
                wybor_inna_opcja_5_a = str(1)
            elif wybor_audio == '2':
                wybor_inna_opcja_5_a = str(2)
            else:
                print('\n' + 'Proszę wybrać odpowiednią liczbę!' + '\n' + '\n')
                mow('Proszę wybrać odpowiednią liczbę.')
                wybor_awaryjny()
            if wybor_inna_opcja_5_a == str(1):
                print('\n' + 'Wybrałeś numer: ' + wybor_inna_opcja_5_a + '\n')
                mow('Wybrałeś numer: ' + wybor_inna_opcja_5_a)
                print('\n' + 'Wybrano powrót do menu.')
                mow('Wybrano powrót do menu.')
                time.sleep(1)
                intro()
            if wybor_inna_opcja_5_a == str(2):
                print('\n' + 'Wybrałeś numer: ' + wybor_inna_opcja_5_a + '\n')
                mow('Wybrałeś numer: ' + wybor_inna_opcja_5_a)
                plik = open('TEXT/motywacja.txt', "r", encoding='utf-8')
                motywacja = plik.readlines()
